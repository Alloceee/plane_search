...
import com.yws.plane.entity.Constants;
import com.yws.plane.entity.QQUserInfo;
import com.yws.plane.util.HttpClientUtils;
import com.yws.plane.util.URLEncodeUtil;
...
public class QQController {
    ...
    public String getCode() throws Exception {
        ...
        url.append("&client_id=").append(constants.getQqAppId());
