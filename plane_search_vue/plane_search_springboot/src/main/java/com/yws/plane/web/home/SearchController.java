...
public class SearchController {
    ...
    public String china_plane(@RequestBody PageEntity page) {
        ...
        if (fightCompanyPlaneVOPage == null) {
            ...
            fightCompanyPlaneVOPage = chinaFightService.getChinaFightCompanyPlane(page1, wrapper).getRecords();
    ...
    public String abroad_plane(@RequestBody PageEntity page) {
        ...
        if (fightCompanyPlaneVOPage == null) {
            ...
            wrapper.eq("start_city", page.getStartCity()).eq("end_city", page.getEndCity());
            fightCompanyPlaneVOPage = abroadFightService.getAbroadFightCompanyPlane(page1, wrapper).getRecords();
            redisUtil.set(page.getStartCity() + "_" + page.getEndCity(), fightCompanyPlaneVOPage);
        }
        return JSONData.toJsonString(200, "", fightCompanyPlaneVOPage);
    }
...
//        if (res == null) {
        ...
        QueryWrapper<AbroadFight> wrapper2 = new QueryWrapper<>();
        wrapper2.eq("start_city", page.getStartCity())
                .eq("end_city", page.getEndCity())
                .ge("start_time", page.getStartTime())
                .le("end_time", page.getEndTime());
        List<FightCompanyPlaneVO> china = chinaFightService.getChinaFightCompanyPlane(page1, wrapper).getRecords();
        List<FightCompanyPlaneVO> abroad = abroadFightService.getAbroadFightCompanyPlane(page1, wrapper2).getRecords();
        china.addAll(abroad);
