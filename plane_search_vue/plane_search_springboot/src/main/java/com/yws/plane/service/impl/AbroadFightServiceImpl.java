...
public class AbroadFightServiceImpl extends ServiceImpl<AbroadFightMapper, AbroadFight> implements AbroadFightService {
    ...
    @Override
    public Page<FightCompanyPlaneVO> getAbroadFightCompanyPlane(Page<FightCompanyPlaneVO> page, Wrapper<AbroadFight> wrapper) {
        return page.setRecords(this.baseMapper.getAbroadFightCompanyPlane(page,wrapper));
    }
    @Override
