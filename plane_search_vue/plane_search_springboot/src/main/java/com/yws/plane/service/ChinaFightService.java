...
public interface ChinaFightService extends IService<ChinaFight> {
    Page<FightCompanyPlaneVO> getChinaFightCompanyPlane(Page<FightCompanyPlaneVO> page, Wrapper<ChinaFight> wrapper);

    List<FightCompanyPlaneVO> allOptions();

    FightCompanyPlaneVO getChinaFightCompanyPlane(@Param("fight_id")Long fight_id);
}
